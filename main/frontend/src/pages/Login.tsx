...
import { ArrowRight, AlertCircle, Compass, FileText, MessageSquare, Headphones } from "lucide-react";
      ...
      <div className="flex-1 grid grid-cols-1 lg:grid-cols-[1fr_420px] min-h-0">
        ...
        <section className="flex items-center justify-center p-6 lg:p-8">
          <div className="w-full max-w-sm space-y-6">
            <div>
              <h2 className="text-[18px] font-medium text-fg">欢迎回来</h2>
              <p className="text-[12px] text-fg-subtle mt-1">登录以开始你的面试训练</p>
            </div>
